...
const SectionCover = ({ img, title, details }) => {
  return (
    <section
      ...
      className="mt-24 md:mt-28 lg:mt-32 xl:mt-36 mb-10 md:mb-14 lg:mb-16 xl:mb-20 cover p-12 md:px-36 md:py-28 lg:px-48 lg:py-32 xl:px-60 xl:py-40 2xl:px-96 2xl:py-48"
    >
